...
/*template<class TYPE>
void oTreeNode::collectCandidates(std::vector<GameObject*>& vec, const TYPE& primitive)
{
...
/*template<class TYPE>
void JOctTree::collectCandidates(std::vector<GameObject*>& vec, const TYPE& primitive)
{
	if (rootNode)
